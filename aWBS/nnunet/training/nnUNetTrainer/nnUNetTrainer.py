...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.run = wandb.init(config={}, project="papar", name=self.configuration_manager.wandb_name, group="aWBS", job_type="nnUnet")
    ...
    def on_train_epoch_start(self):
        ...
        self.run.log({"lr": self.optimizer.param_groups[0]['lr']}, step=self.current_epoch)
    ...
    def on_train_epoch_end(self, train_outputs: List[dict]):
        ...
        self.run.log({"train_loss": loss_here}, step=self.current_epoch)
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        self.run.log({"val_loss": loss_here, "mean_fg_dice": mean_fg_dice, "dice_per_class_or_region": global_dc_per_class}, step=self.current_epoch)
