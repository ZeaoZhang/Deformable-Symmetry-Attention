...
if __name__ == '__main__':
    ...
    brats_data_dir = '/home/zhangzeao/experiment/data/brats2023/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData_1'

    task_id = 137
    task_name = "BraTS2023"

    foldername = "Dataset%03.0d_%s" % (task_id, task_name)
    nnUNet_raw = '/home/zhangzeao/experiment/data/nnUNet_results'
